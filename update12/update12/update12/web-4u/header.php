...
#more {
    ...
    outline: none;
      ...
      <?php 
          ...
          $active_links[] = "/web-4u/index.php";

            for($j=1;$j<=$queryResults;$j++) {
              $active_links[] = "/web-4u/HomeAppliance.php?category_id=$j";
            }
          ...
          echo "<div class='header-sub-nav'>
                <div class='sub-nav'>
                  <ul class='nav-links'>
                  <li><a href='index.php' class='".($_SESSION['active_link'] === '/web-4u/index.php' ? 'active-2' : '')."'>Home</a></li>";
            ...
            if($queryResults > 0) {
                ...
                while (($row = mysqli_fetch_assoc($result))) {
                  ...
                  echo "<li><a href='HomeAppliance.php?category_id=".$row["category_id"]."' class='". ($_SESSION['active_link'] === "/web-4u/HomeAppliance.php?category_id=" . $row["category_id"] . "" ? 'active-2' : '') . "'>" . $row["category_name"] . " </a></li>";
                  $i++;
